...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-85510186.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-e806fc46.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'remoteApp':{url:'http://localhost:5001/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-85510186.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'18.3.1':{get:()=>get(new URL('__federation_shared_react-dom-e806fc46.js', import.meta.url).href, remoteFrom), loaded:1}}
